 ...
 * Created on October 10, 2022, 1:14 PM
...
struct battleShip {                                           // Declare a structure for different types battle ship 
    int aircraft[5][1];                                       // Aircraft length is 5 for tracking its coordinate values (row,col)
    int battleship[4][1];                                     // Battleship length is 4 for tracking its coordinate values (row,col)
    int destroyer[3][1];                                      // Destroyer length is 3 for tracking its coordinate values (row,col)
    int corvette[2][1];                                       // Corvette length is 2 for tracking its coordinate values (row,col)     
};
