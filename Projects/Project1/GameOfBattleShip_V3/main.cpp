 ...
 * Created on October 14, 2022, 6:30 am
...
enum yCoord { A, B, C, D, E, F, G, H, I, J };                 // Take a enum type for calculating the ycoordinate position
//Function Prototypes
...
battleShip setComputerBattleShip(char**);//Set computer ship position and return structure
    ...
    while (true)                                        // loop for setup the battleship position    
    {
        ...
        if (tolower(shipOrientiation) == 'h')                               // check for horizontal setup
        {
            ...
            else
            {
                ...
                {
                    playerMatrix[startPositionRow][i] = 'C';                          // set the player matrix with 'C' for indicationg the battle location
        ...
        if (tolower(shipOrientiation) == 'v')                                   // check for the vertical setup
        {
            ...
            else
            {
                ...
                {
                    playerMatrix[i][startPositionCol] = 'C';                       // set the player matrix with 'C' for indicationg the battle location
...
battleShip setComputerBattleShip(char** computerMatrix) {
    ...
    {                                                                       // Otherwise orientation is vertical
        ...
        {
            computerMatrix[i][colPosition] = 'A';                       // Set the player matrix with 'A' for indicationg the battle location
    ...
    if (shipOrientation == 0)                       // If value is 0 then consider the orientation as horizontal;
    {
        ...
        {
            computerMatrix[rowPosition][i] = 'B';                          // Set the computer matrix with 'B' for indicationg the battleship location
    ...
    {                                                                       // Otherwise orientation is vertical
        ...
        {
            computerMatrix[i][colPosition] = 'B';                       // Set the player matrix with 'B' for indicationg the battle location
    ...
    if (shipOrientation == 0)                         // If value is 0 then consider the orientation as horizontal;
    {
        ...
        {
            computerMatrix[rowPosition][i] = 'C';                          // Set the computer matrix with 'C' for indicationg the battleship location
    ...
    else
    {
        ...
        {
            computerMatrix[i][colPosition] = 'C';                       // Set the player matrix with 'C' for indicationg the battle location
